...
class MainWindow:
    ...
    def setup_ui(self):
        ...
        input_label = ttk.Label(self.root, text="Import Customer Loan Data with mandatory column:")
        ...
        output_label = ttk.Label(self.root, text="Save the Output file in xlsx format:")
    ...
    def process_data(self):
        ...
        if not input_file or not output_file:
            messagebox.showerror("Error", "Please select both Customer Loan data and output files.")
            return
